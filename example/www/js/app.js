...
****/
            ...
            /*         var now = new Date().getTime();
                     var delay = new Date(now + 15 * 1000);
                     ...
                     cordova.plugins.notification.local.schedule({
                         ...
                         at: delay,
                         text: "Single Notification",
                         sound: "/System/Library/Audio/UISounds/New/Bloom.caf"
                             //1. From custom sound story in the www folder: file://folder/filename
                             //2. From native sound: system sound url
                     });    */
